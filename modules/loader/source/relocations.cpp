...
bool resolveRISCV(const loader::Relocation &r, loader::ElfMap &map,
  ...
  switch (r.type) {
    ...
    case R_RISCV_JAL: {
      // R_RISCV_JAL immediate is for J-Type instructions and is split
      // across 20 bits spread across the instruction and skips the bottom bit
      // of the input relative offset. See conditional branches in the isa spec.
    ...
    case R_RISCV_RVC_BRANCH: {
      // R_RISCV_RVC_BRANCH is for compressed instructions and fits in bits 2-6

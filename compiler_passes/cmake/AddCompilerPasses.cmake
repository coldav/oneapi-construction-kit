...
set(OCK_CHECK_TARGET check-ock-compiler)

# Add the check-ock-compiler target to run all registered checks, see add_ca_check()
...
.. cmake:command:: add_ca_check_group
  ...
  .. code:: CMake
    ...
    add_ca_check_group(foo DEPENDS bar check-ock-compiler-foo)
#]=======================================================================]
...
.. cmake:command:: ca_umbrella_lit_testsuite_open
  ...
  ``check-ock-compiler-all-lit:      foo, bar, baz``

  ``check-ock-compiler-compiler-lit: bar, baz``

  ``check-ock-compiler-foo-lit:      foo``

  ``check-ock-compiler-bar-lit:      bar``

  ``check-ock-compiler-baz-lit:      baz``

  ``check-ock-compiler-special-lit:  special``
